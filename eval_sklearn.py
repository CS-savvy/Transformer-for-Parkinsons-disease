...
def evaluate(df, model_dir, data, split_details=None):
    conf_threshold = 0.5
    ...
    val_aucs = []
    for i in range(1, 11):
        val_indices = id_to_index(df, split_details[f'val_{i}'])
...
if __name__ == "__main__":
    ...
    model_dir = this_dir / "models/xgboost"
    ...
    evaluate(df, model_dir, (features, labels), split_details=split_detail)
